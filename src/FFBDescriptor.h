...
static const uint8_t pidReportDescriptor[] PROGMEM= {
  ...
  // PID State Report - Report ID 0x2
  ...
  0xA1, 0x02,          	// COLLECTION (Logical)
    ...
    0xA1, 0x02,   		 // Collection Datalink
        ...
        0x95, 0x06,          //  Report Count (6) - 6 bits
        0x81, 0x02,          // Input (variable,absolute)	
  ...
  0xA1, 0x02,           //Collection Datalink (Logical)
    ...
    0xA1, 0x02,           	//    Collection Datalink (Logical)	
        ...
        0x09, 0x29,           	// Usage (29) Reserved (Unused)
        0x15, 0x01,           	//  Logical Minimum (1)
    ...
    0x95, 0x08 - FFB_AXIS_COUNT - 1, //        Report Count (4) (05 (2 axes) or 06 (1 axes)) seems to be for padding
    ...
    0xA1, 0x02,           //        Collection Datalink (Logical)
      ...
      #endif
      0x66, 0x14, 0x00,     //          Unit (20d) (Eng Rot:Angular Pos)
  ...
  // SetEnvelopeReport - Report ID 0x2
  ...
  // SetConditionReport - Report ID 3
  ...
  // SetConstantForceReport - Report ID 5
  ...
  // SetRampForceReport - Report ID 6
  ...
  // CustomForceDataReport - Report ID 7
  ...
  // DownloadForceSample - Report ID 8
  ...
  // EffectOperationReport - Report ID 10
  0x05, 0x0F,           //Usage Page (Physical Interface)
  ...
  // PIDBlockFreeReport - Report ID 11
  ...
  //SetCustomForceReport - Report ID 14
  ...
  //CreateNewEffectReport - REPORT_ID (05)
  ...
  // PIDBlockLoadReport - REPORT_ID (06)
  0x05, 0x0F, 		// USAGE_PAGE (Physical Interface)
  ...
  0xA1, 0x02, 		// COLLECTION (Logical)
    ...
    0x09, 0x22, 		// USAGE (Effect Block Index)
    0x15, 0x01, 		//  LOGICAL_MINIMUM (01)
    0x25, 0x28, 		//  LOGICAL_MAXIMUM (40d)
    0x35, 0x01, 		//  PHYSICAL_MINIMUM (01)
    0x45, 0x28, 		//  PHYSICAL_MAXIMUM (40d)
    0x75, 0x08, 		//  REPORT_SIZE (08)
    0x95, 0x01, 		//  REPORT_COUNT (01)
    0xB1, 0x02, 		//  FEATURE (Data,Var,Abs)
